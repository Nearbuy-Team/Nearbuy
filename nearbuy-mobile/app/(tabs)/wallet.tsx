  ...
  return (
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: c.canvas }}>
      ...
      <Text
        ...
        {sandboxMode ? 'Demo wallet' : 'Payouts'}
      </Text>
      ...
      <ScrollView
        ...
        <LinearGradient
          ...
          style={{ borderRadius: 22, padding: 20, overflow: 'hidden', marginBottom: 20 }}>
          <View
            style={{
              position: 'absolute',
              right: -30,
          ...
          <Text
            ...
            {sandboxMode ? 'Demo balance' : 'Recorded net payouts'}
          </Text>
          <Text
            style={{
              fontFamily: FONTS.extrabold,
          ...
          {sandboxMode ? (
            <View style={{ flexDirection: 'row', gap: 9, marginTop: 16 }}>
              <Pressable
                ...
                <Text
                  style={{ fontFamily: FONTS.extrabold, fontSize: 13, color: theme.accentText }}>
                  Top up demo
                </Text>
              </Pressable>
              <Pressable
        ...
        <Text
          style={{ fontFamily: FONTS.extrabold, fontSize: 13.5, color: c.ink, marginBottom: 12 }}>
          Payment activity
        </Text>
            ...
            return (
              <View
                ...
                <View style={{ flex: 1, minWidth: 0 }}>
                  <Text
                    numberOfLines={1}
                    style={{ fontFamily: FONTS.bold, fontSize: 13.5, color: c.ink }}>
                ...
                <Text
                  style={{
                    fontFamily: FONTS.extrabold,
                    fontSize: 14,
                    color: incoming ? c.success : c.ink,
                  }}>
                  {incoming ? '+' : '−'} {formatGhs(transaction.amount)}
                </Text>
              </View>
            );
          })}
